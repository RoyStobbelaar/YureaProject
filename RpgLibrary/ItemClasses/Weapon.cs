...
namespace XRpgLibrary.ItemClasses
{
    public class Weapon : BaseItem
    {
        ...
        public Weapon(string weaponName, string weaponType, int price, float weight, Hands hands, 
            int attackValue, int attackModifier, int damageValue, int damageModifier, params string[] allowableClasses)
        ...
        public override object Clone()
        {
            ...
            Weapon weapon = new Weapon(
                Name, Type, Price, Weight, NumberHands, AttackValue, AttackModifier, DamageValue, DamageModifier, allowedClasses);
